...
export const PERCORSI_MOCK: Percorso[] = [
  {
    ...
    titolo: "Guida al Rilascio della Carta d'Identità Elettronica (CIE)",
    ...
    passiDettagli: [
      "Accedi al Portale Ministeriale CIE Prenotazioni e seleziona il tuo Comune per scegliere giorno e ora dell'appuntamento.",
      "Assicurati di possedere una foto tessera recente (norma ICAO), la ricevuta PagoPA del versamento (€ 22,21) e il vecchio documento.",
      "Recati all'Ufficio Anagrafe Centrale munito di documenti. Verranno acquisite le tue impronte digitali e la firma.",
      "La CIE viene stampata dall'Istituto Poligrafico e spedita tramite raccomandata al tuo indirizzo entro 6 giorni lavorativi."
    ],
    documentiNecessari: [
      { id: "chk-1-1", testo: "Ricevuta PagoPA del pagamento dei diritti di segreteria (€ 22,21)", completato: true, obbligatorio: true, documentoId: "doc-3" },
    ...
    cronologia: [
      { id: "ev-1-1", data: "15-06-2026 09:30", titolo: "Inizio Percorso Guida", descrizione: "Selezionata la guida per il rilascio della CIE. Iniziata la verifica dei requisiti." },
    ...
    linkPortaleUfficiale: "https://www.prenotazionicie.interno.gov.it/",
    nomePortaleUfficiale: "Portale CIE Ministero dell'Interno",
    note: "Allo sportello anagrafe sarà necessario presentare la ricevuta di prenotazione (stampata o su smartphone) contenente il numero dell'appuntamento."
  },
  {
    id: "percorso-2",
    ...
    passiDettagli: [
      ...
      "Accedi all'area riservata MyINPS con SPID o CIE e inserisci i dati dei figli, il codice fiscale dell'altro genitore e l'IBAN.",
    ...
    note: "Se non si presenta l'ISEE corretto, l'assegno verrà comunque erogato ma nella misura minima prevista dalla legge."
  },
  {
    id: "percorso-3",
    ...
    passiDettagli: [
      ...
      "Accedi ad ANPR con SPID/CIE, seleziona 'Cambio Residenza' e inserisci i moduli compilando ogni campo.",
      "L'anagrafe comunale effettuerà le verifiche entro 45 giorni dall'invio telematico."
    ],
    documentiNecessari: [
    ...
    note: "La dichiarazione è resa ai sensi del DPR 445/2000. Dichiarazioni mendaci sono perseguibili penalmente."
  }
];
...
export const DOCUMENTI_MOCK: Documento[] = [
  ...
  {
    id: "doc-3",
    nome: "Ricevuta_Pagamento_PagoPA_CIE_8819.pdf",
    tipo: "PDF",
    dimensione: "94 KB",
    dataCaricamento: "2026-06-18",
    collegatoAPercorsoId: "percorso-1",
    percorsoTitolo: "Guida al Rilascio della CIE",
    stato: "valido"
  },
  {
    id: "doc-4",
    nome: "Foto_Tessera_Biagio_ICAO.jpg",
    tipo: "JPEG",
    dimensione: "1.2 MB",
...
export const SERVIZI_MOCK: Servizio[] = [
  {
    ...
    categoria: "Anagrafe e Stato Civile",
    requisiti: ["SPID o Carta d'Identità Elettronica", "Atto catastale o contratto di locazione", "Codici fiscali del nucleo"],
  ...
  {
    id: "srv-2",
    titolo: "Richiesta Carta Identità Elettronica (CIE)",
    ...
    categoria: "Anagrafe e Stato Civile",
    requisiti: ["Foto tessera cartacea o digitale", "Documento scaduto o denuncia", "Pagamento PagoPA di € 22,21"],
    tempoStimato: "6 giorni dalla visita",
    ufficioCompetente: "Servizi Demografici Comunali",
    linkPortaleUfficiale: "https://www.prenotazionicie.interno.gov.it/",
    nomePortaleUfficiale: "Portale Prenotazione CIE",
    popolare: true
  },
  {
    id: "srv-3",
...
export const ASSISTENTE_INITIAL_MESSAGGI: Messaggio[] = [
  {
    ...
    suggerimenti: [
      ...
      "Quali sono i passi per rinnovare la CIE?",
